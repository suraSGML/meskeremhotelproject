  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroImage} alt="Meskerem Hotel exterior" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-cream/80 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-light leading-relaxed animate-fade-up opacity-0 animation-delay-300">
            ...
            the premier destination for unforgettable weddings and extraordinary stays.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up opacity-0 animation-delay-400">
            ...
            <Link to="/accommodations">
              <Button variant="heroOutline" size="xl">Reserve Your Suite</Button>
            </Link>
          </div>
          ...
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-cream/60 text-sm animate-fade-up opacity-0 animation-delay-500">
            <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gold" /><span>5-Star Luxury</span></div>
            <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gold" /><span>500+ Weddings Hosted</span></div>
            <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gold" /><span>Award-Winning Cuisine</span></div>
          </div>
        </div>
      </div>
