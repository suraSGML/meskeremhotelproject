...
const EventInquiryForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Our events team will contact you within 24 hours to discuss your celebration.",
    });
    // Reset form
    setStep(1);
    setFormData({
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Share your vision with us, and our dedicated events team will craft 
              an unforgettable experience tailored to your dreams.
            </p>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="bg-background p-8 md:p-12 rounded-sm shadow-elevated">
              ...
              <div className="space-y-8 animate-fade-up">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {eventTypes.map((type) => (
                      <button
                        ...
                        className={`p-4 text-sm border rounded-sm transition-all ${
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {guestRanges.map((range) => (
                      <button
                        key={range}
                        type="button"
                        onClick={() => setFormData({ ...formData, guestCount: range })}
                        className={`p-4 text-sm border rounded-sm transition-all ${
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    size="lg"
                    onClick={() => setStep(2)}
                    disabled={!formData.eventType || !formData.guestCount}
                    className="group"
                  >
                    Continue
            ...
            {step === 3 && (
              <div className="space-y-8 animate-fade-up">
                <div>
                  ...
                  <Textarea
                    placeholder="Share any specific requirements, themes, or questions you have about your event..."
                ...
                <div className="p-6 bg-muted rounded-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-foreground font-medium">{formData.eventType}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Guest Count</p>
                      <p className="text-foreground font-medium">{formData.guestCount}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Preferred Date</p>
                      <p className="text-foreground font-medium">
                        {formData.eventDate || "Flexible"}
                      </p>
                    </div>
                    <div>
